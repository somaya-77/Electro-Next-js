...
const ProductCard = ({ categories, title, img, price }: props) => {
    return (
        <div className='flex-shrink-0 flex-1 flex_col gap-2 p-5 border-r border-light_2 last:border-r-0 cursor-pointer hover:shadow-xl group'>
            ...
            <div className='max-h-[200px] flex_center'>
